...
test("Não deve obter um quarto disponível para reserva em um período", async function() {
  const roomRepository = new RoomRepositoryDatabase()
  const rooms = await roomRepository.getAvailableRoomsByPeriodAndCategory(new Date('2021-03-11T10:00:00'), new Date('2021-03-05T12:00:00'), 'suite')
