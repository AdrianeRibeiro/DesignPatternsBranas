...
describe('Não deve criar um financiamento imobiliário', () => {
  test("com prazo superior a 420 meses", function() {
    expect(() => 
      MortgageLoan.create(100000, 10000, 450)
    ).toThrow(
      new Error("The maximum number of installments for mortgage loan is 420")
    )
  })

  test("caso a parcela ocupe um valor superior a 25% da renda mensal", function() {
    expect(() => 
      MortgageLoan.create(200000, 1000, 420)
    ).toThrow(
...
describe('Não deve criar um financiamento veicular', () => {
  test("com prazo superior a 60 meses", function() {
    expect(() => 
  ...
  test("caso a parcela ocupe um valor superior a 30% da renda mensal", function() {
    expect(() => 
