...
for (const line of data.split("\n")) {
  const [draw, date, bet1, bet3, bet4, bet5, bet6] = line.split(";")
  const ticket = new LotteryTicket(FlyweightFactory.getDrawFlyweight(draw, date), bet1, bet3, bet4, bet5, bet6)
  tickets.push(ticket)
}
